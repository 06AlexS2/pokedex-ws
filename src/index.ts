...
if (process.env.NODE_ENV === "development") {
  ...
  app.post('/api/v1/catch/pokemon-name/:pokemon', pokemonController.savePokemonIntoDB.bind(pokemonController));
  app.delete('/api/set-free/pokemon-id/:id', pokemonController.releasePokemonById.bind(pokemonController));
  app.delete('/api/set-free/pokemon-name/:pokemon', pokemonController.releasePokemonByName.bind(pokemonController));
}
